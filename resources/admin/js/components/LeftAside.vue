    ...
    <aside class="page-sidebar">
        ...
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                <li v-for="(item, key) in menus" :key="`_root${key}`">
                    <a href="#" title="san pham" data-filter-tags="san pham">
                    ...
                    <ul>
                        <li
                            v-for="(chil, index) in item.childrens"
                            :key="`item${index}`"
                        >
                            <router-link
                                :to="{ name: `${chil.url}` }"
                                title="danh muc"
                                data-filter-tags="san pham danh muc"
                                exact
                            >
                                <span
                                    class="nav-link-text"
